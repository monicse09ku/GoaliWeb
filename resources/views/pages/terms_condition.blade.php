...
@section('title', 'Page|Terms & Condition')
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{url('clients')}}">Page|Terms & Condition</a>
                        <i class=""></i>
                    </li>
                    <li>
                        <span>Edit</span>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <form  id="page_form" method="post" action="" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <input type="hidden" name="page_name" value="terms_condition">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="page_content" id="page_content">@if(!empty($page_data)){{$page_data->page_content}}@endif</textarea>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).on("submit", "#page_form", function(event) {
            ...
            if (page_content.trim() == "") {
                validate = validate + "Page content is required</br>";
            }

            if (validate == "") {
                var formData = new FormData($("#page_form")[0]);
                var url = "{{ url('pages/update') }}";

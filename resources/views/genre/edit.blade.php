...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <form  id="genre_form" method="post" action="" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <input type="hidden" name="id" value="{{$genre->id}}">
                        <input type="hidden" name="user_id" value="{{$genre->user_id}}">
...
@section('js')
    ...
    <script>
        ...
        $(document).on("submit", "#genre_form", function(event) {
